    ...
    switch (this.type_) {
      ...
      case AnnouncementTypes.TWO_OF_A_KIND:
        return [
          ...
          [
            AnnouncementSubject.TEXT,
            " plays two of a kind to steal a random card from ",
          ],
          [AnnouncementSubject.PLAYER, this.target_!.name],
          [AnnouncementSubject.TEXT, "!"],
        ];
      ...
      case AnnouncementTypes.THREE_OF_A_KIND:
        return [
          ...
          [
            AnnouncementSubject.TEXT,
            " plays three of a kind to steal a specific card from ",
          ],
          [AnnouncementSubject.PLAYER, this.target_!.name],
          [AnnouncementSubject.TEXT, "!"],
        ];
      ...
      case AnnouncementTypes.FIVE_DIFFERENT:
        return [
          ...
          [
            AnnouncementSubject.TEXT,
            " plays 5 different cards to take from the discard pile!",
          ],
        ];
      ...
      case AnnouncementTypes.PUT_BOMB:
        return [
          ...
          [
            AnnouncementSubject.TEXT,
            " defused and puts the bomb back in the deck!",
          ],
        ];
